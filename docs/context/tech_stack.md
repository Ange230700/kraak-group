...
/
├─ apps/
│  ├─ client/                        # Frontend Angular workspace
│  │  ├─ projects/
│  │  │  ├─ web/                     # Angular + PrimeNG (site web)
...
- **Vercel** déploie `apps/client/projects/web`
...
- `apps/client/projects/web/tailwind.config.*` si nécessaire selon setup
- `apps/client/projects/web/src/app/app.routes.server.ts` si rendu hybride/prerender avancé
- `apps/client/projects/mobile/capacitor.config.ts`
...
### Variables front-end web (`apps/client/projects/web`)
...
### Variables front-end mobile (`apps/client/projects/mobile`)
