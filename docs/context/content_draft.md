...
## 4. Textes juridiques ⚖️

### Politique de confidentialité (résumé)

Nous collectons uniquement les données nécessaires au traitement des demandes et ne les partageons pas sans consentement.
...
Un contenu complet, structuré et directement intégrable dans le MVP.
